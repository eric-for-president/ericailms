...
import trency from './treny.png'
import ujjwal from './ujjwal.png'
import anushka from './anushka.png'
export const assets = {
    trency,
    ujjwal,
    anushka,
...
export const dummyTestimonial = [
    {
        name: 'Trency Chand',
        role: 'Student @ CalTech',
        image: assets.trency,
        rating: 5,
        feedback: 'Eric AI has revolutionized my teaching experience. The platform is intuitive, making course creation and student engagement seamless.',
    },
    {
        name: 'Ujjwal Basnet',
        role: 'Student @ MIT',
        image: assets.ujjwal,
        rating: 4.8,
        feedback: 'Eric AI provides an exceptional learning environment. The structured courses, real-time tracking, and user-friendly interface are top-notch.',
    },
    {
        name: 'Anushka Katwal',
        ...
        rating: 4.7,
        feedback: 'Eric AI is a fantastic platform for upskilling. Its diverse course library and smooth UI make learning highly effective and engaging.',
    },
];
